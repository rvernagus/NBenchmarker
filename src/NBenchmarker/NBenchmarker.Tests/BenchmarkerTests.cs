...
namespace NBenchmarker.Tests
{
    ...
    public class BenchmarkerTests
    {
        ...
        [TestClass]
        public class TheRunMethod : BenchmarkerTests
        {
            [TestMethod]
            ...
            [TestMethod]
            public void RecordsStopwatchElapsedTimeInResult()
            {
            ...
            [TestMethod]
            public void IteratesOneTimeByDefault()
            {
                var result = benchmarker.Run(trial);
        ...
        [TestClass]
        public class TheShouldContinueMethod : BenchmarkerTests
        {
            [TestMethod]
